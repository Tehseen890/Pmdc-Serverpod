...
import 'package:pmdccolleges_flutter/ui/teacher/teacher_home_screen/teacher_subject_screen/teacher_subject_detail_screen/teacher_subject_detail_screen.dart';
                ...
                child: TabBar(
                    ...
                    tabs: List.generate(
                      ...
                      (index) => Center(
                        child: Tab(
                            text:
                                "${programs[model.filterSubject[index].programId - 1] == "Computer Sciences" ? "Course: C.S\n" : programs[model.filterSubject[index].programId - 1] == "Pre-Engineering" ? "Course: Engineering\n" : "Course: ${programs[model.filterSubject[index].programId - 1]}\n"}Section: ${model.filterSubject[index].section}\n${model.filterSubject[index].subjectName}"),
                      ),
                    )
