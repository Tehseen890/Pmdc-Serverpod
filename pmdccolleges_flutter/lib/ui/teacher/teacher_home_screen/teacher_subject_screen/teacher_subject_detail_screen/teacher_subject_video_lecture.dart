...
import 'package:pmdccolleges_flutter/core/services/file_download.dart';
...
class TeacherVideoLectureScreen extends StatelessWidget {
  int index;
            ...
            children: [
              ...
              Expanded(
                child: Row(
                  ...
                  children: [
                    Expanded(
                      child: Text('${videoLecture.chapterName} ',
                          style: TextStyle(
                              //  color: Colors.white,
                              fontSize: 21,
                              fontWeight: FontWeight.bold),
                    ...
                    Expanded(
                      child: Row(
                        children: [
                          ...
                          IconButton(
                            onPressed: () {
                              model.deleteSubjectNote(videoLecture.id);
                            },
