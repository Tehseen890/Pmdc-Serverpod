...
class NoticeBoardEndpoint extends Endpoint {
  ...
  Future<List<NoticeBoard>> getNotice(Session session) async {
    return await NoticeBoard.find(
      session,
      // where: (notice) => notice.noticeId.equals(noticeId),
    );
  }
}
