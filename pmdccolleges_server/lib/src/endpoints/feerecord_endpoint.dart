import 'package:pmdccolleges_server/src/generated/feerecord.dart';
...
class FeeRecordEndpoint extends Endpoint {
  ...
  Future<List<FeeRecord>> getFeeRecord(
      Session session, String studentId) async {
    return await FeeRecord.find(
      session,
      where: (feerecord) => feerecord.studentId.equals(studentId),
    );
  }
}
