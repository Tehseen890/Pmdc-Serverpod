...
class AssignSubjectsEndpoint extends Endpoint {
  ...
  Future<List<AssignSubjects>?> getTeacherSubjects(
    Session session,
    int? teacherId,
  ) async {
    return await AssignSubjects.find(
      session,
      where: (subjct) => subjct.teacherId.equals(teacherId.toString()),
    );
  }
