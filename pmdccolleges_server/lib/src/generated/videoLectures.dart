...
class VideoLectures extends _i1.TableRow {
  VideoLectures({
    int? id,
  ...
  static final t = VideoLecturesTable();
  ...
  @override
  String get tableName => 'videolectures';
  @override
  ...
  static Future<List<VideoLectures>> find(
    _i1.Session session, {
    VideoLecturesExpressionBuilder? where,
    int? limit,
    int? offset,
    _i1.Column? orderBy,
    ...
    return session.db.find<VideoLectures>(
      where: where != null ? where(VideoLectures.t) : null,
      limit: limit,
      offset: offset,
      orderBy: orderBy,
  ...
  static Future<VideoLectures?> findSingleRow(
    _i1.Session session, {
    VideoLecturesExpressionBuilder? where,
    int? offset,
    _i1.Column? orderBy,
    ...
    return session.db.findSingleRow<VideoLectures>(
      where: where != null ? where(VideoLectures.t) : null,
      offset: offset,
      orderBy: orderBy,
      orderDescending: orderDescending,
  ...
  static Future<VideoLectures?> findById(
    _i1.Session session,
    int id,
  ) async {
    return session.db.findById<VideoLectures>(id);
  }

  static Future<int> delete(
    _i1.Session session, {
    required VideoLecturesExpressionBuilder where,
    _i1.Transaction? transaction,
  }) async {
    return session.db.delete<VideoLectures>(
      where: where(VideoLectures.t),
      transaction: transaction,
    );
  }
  ...
  static Future<int> count(
    ...
    return session.db.count<VideoLectures>(
      where: where != null ? where(VideoLectures.t) : null,
      limit: limit,
      useCache: useCache,
      transaction: transaction,
...
typedef VideoLecturesExpressionBuilder = _i1.Expression Function(
    VideoLecturesTable);

class VideoLecturesTable extends _i1.Table {
  VideoLecturesTable() : super(tableName: 'videolectures');
...
@Deprecated('Use VideoLecturesTable.t instead.')
VideoLecturesTable tVideoLectures = VideoLecturesTable();
